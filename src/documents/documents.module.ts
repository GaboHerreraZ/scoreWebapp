 ...
 * Cada tipo tiene su propio modelo, controller y rutas bajo
 * companies/:companyId/documents/..., pero comparten el motor de firma (Zapsign)
 * vía SigningModule.
 */
@Module({
  imports: [PromissoryNotesModule],
  exports: [PromissoryNotesModule],
})
